...
// 1. ലോഡിങ് സമയത്ത് മിന്നിത്തിളങ്ങുന്ന ഷിമ്മർ ആനിമേഷൻ കാണിക്കുന്നു
const showShimmer = () => {
...
const displayProducts = (products, isNew) => {
    ...
    products.forEach(product => {
        ...
        // വലതുവശത്തെ ചെക്ക്ബോക്സിൽ തൊട്ടാൽ കംപാരിസൺ
        ...
        // കാർഡിൽ തൊട്ടാൽ സിംഗിൾ പ്രോഡക്റ്റ് ഡീറ്റെയിൽസ് (Image -> Name -> Grade -> Brand -> Details)
...
// സിംഗിൾ പ്രോഡക്റ്റ് വ്യൂ സെറ്റ് ചെയ്യുന്നു
